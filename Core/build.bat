...
set linker_flags=gdi32.lib user32.lib kernel32.lib shell32.lib /out:CogwheelCore.lib ../src/vendor/assimp/lib/assimp-vc142-mtd.lib
set source_files=../src/*.cpp ../src/rendering/*.cpp ../src/event/*.cpp ../src/ecs/*.cpp ../src/project/*.cpp ../src/vendor/stb_image/*.c
